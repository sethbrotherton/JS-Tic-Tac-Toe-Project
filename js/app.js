...
function computerPlayingHard () {
  ...
  for (let i = 0; i < winningCombos.length; i++) {
    //hardXSquares = [];
    if (winningCombos[i][0].classList.contains('box-filled-1') && winningCombos[i][1].classList.contains('box-filled-1') && !winningCombos[i][2].classList.contains('box-filled-1')) {
      ...
      // displayWinner('box-filled-2', 'X', 'screen-win-two');
    //  return
  } else if (winningCombos[i][1].classList.contains('box-filled-1') && winningCombos[i][2].classList.contains('box-filled-1') && !winningCombos[i][0].classList.contains('box-filled-1')) {
      ...
      // displayWinner('box-filled-2', 'X', 'screen-win-two');
    //  return
    } else if (winningCombos[i][0].classList.contains('box-filled-1') && winningCombos[i][2].classList.contains('box-filled-1') && !winningCombos[i][1].classList.contains('box-filled-1')) {
      console.log('3');
      //winningCombos[i][1].classList.add('box-filled-2');
      hardXSquares = [];
    ...
    //  return
    ...
    else if (winningCombos[i][1].classList.contains('box-filled-1') && !winningCombos[i][2].classList.contains('box-filled-1')) {
      //winningCombos[i][2].classList.add('box-filled-2');
      console.log('4');
      hardXSquares = [];
      hardXSquares.push(winningCombos[i][2]);
      ...
      // displayWinner('box-filled-2', 'X', 'screen-win-two');
    //  return
    } else if (winningCombos[i][2].classList.contains('box-filled-1') && !winningCombos[i][1].classList.contains('box-filled-1')) {
      //winningCombos[i][1].classList.add('box-filled-2');
      console.log('5');
      hardXSquares = [];
      hardXSquares.push(winningCombos[i][1]);
      ...
      // displayWinner('box-filled-2', 'X', 'screen-win-two');
    //  return
    }  else if (winningCombos[i][0].classList.contains('box-filled-1') && !winningCombos[i][1].classList.contains('box-filled-1')) {
      console.log('6');
      hardXSquares = [];
      hardXSquares.push(winningCombos[i][1]);
      // let randomHardXSquare = hardXSquares[Math.floor(Math.random() * hardXSquares.length)].classList.add('box-filled-2');
